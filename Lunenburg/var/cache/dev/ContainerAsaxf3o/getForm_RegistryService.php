...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\ArtikelType' => function () {
...
}, 'AppBundle\\Form\\GoederenType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\GoederenType']) ? $this->services['AppBundle\Form\GoederenType'] : $this->services['AppBundle\Form\GoederenType'] = new \AppBundle\Form\GoederenType()) && false ?: '_'};
}, 'AppBundle\\Form\\LeverancierType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\LeverancierType']) ? $this->services['AppBundle\Form\LeverancierType'] : $this->services['AppBundle\Form\LeverancierType'] = new \AppBundle\Form\LeverancierType()) && false ?: '_'};
}, 'AppBundle\\Form\\MagazijnType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\MagazijnType']) ? $this->services['AppBundle\Form\MagazijnType'] : $this->services['AppBundle\Form\MagazijnType'] = new \AppBundle\Form\MagazijnType()) && false ?: '_'};
